...
// rider: ordinary mana that scries 1 when spent on a creature spell
// sharing a type with your commander (#232: it restricts nothing).
...
card!(
    ...
    abilities = &[mana_ability!(&[Effect::mana_commander_identity()
        .when_spent(&COMMANDER_TYPE_CREATURE_SPELL, SpendRider::Scry(1),)])],
);
