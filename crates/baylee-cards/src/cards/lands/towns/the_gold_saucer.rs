...
// PARTIAL — the mana ability and the two-artifact draw are built; the coin
// flip has no vocabulary (see the NOT SUPPORTED comment beside the list).
...
card!(
    ...
    coverage = Coverage::Partial("no effect flips a coin"),
    abilities = &[
        ...
        // "Sacrifice two artifacts" is two parts, one question each.
        activated!(
            cost!(
                "{3}",
                TapSelf,
