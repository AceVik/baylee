...
// PARTIAL — activated ability returns an artifact with MV <= 3 from your graveyard to the battlefield; ETB search-to-graveyard is not in the DSL.

use baylee_cards_dsl::prelude::*;
use baylee_core::generated::subtypes;

static SMALL_ARTIFACT: Filter = Filter::And(&[Filter::ARTIFACT, Filter::CmcAtMost(3)]);
...
card!(
    ...
    coverage = Coverage::Partial("ETB library search to graveyard is not supported"),
    faces = &[face!(
