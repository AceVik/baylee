...
card!(
    ...
    coverage =
        Coverage::Partial("populate is written as a target, so a token with shroud is unreachable"),
    abilities = &[
        triggered!(
            Trigger::StepBegin {
        ...
        triggered!(
            Trigger::EntersBattlefield(&CREATURE_TOKEN_YOU_CONTROL),
            &[Effect::AddCounter {
